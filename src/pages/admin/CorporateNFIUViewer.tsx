...
interface CorporateNFIUViewerProps {
  data: any;
  onClose: () => void;
}

const CorporateNFIUViewer: React.FC<CorporateNFIUViewerProps> = ({ data, onClose }) => {
  ...
  const extractDirectorsData = (data: any) => {
    ...
    if (data.firstName2 || data.lastName2) {
      const director = {
        ...
        dateOfBirth: data.dob2 || data.dateOfBirth2 || '',
        ...
        sourceOfIncomeOther: data.sourceOfIncomeOther2 || ''
      };
      directors.push(director);
    }
  ...
  const downloadPDF = async () => {
    const element = document.getElementById('corporate-nfiu-pdf-content');
    if (!element) return;
    ...
    try {
      ...
      pdf.setFontSize(16);
      pdf.setTextColor(0, 0, 0);
      pdf.text('Corporate NFIU Form', 20, 65);
      ...
      pdf.save(`Corporate_NFIU_${data.insured || 'form'}.pdf`);
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold">Corporate NFIU Form</h2>
      ...
      <div id="corporate-nfiu-pdf-content" className="space-y-6 bg-white p-6">
        {/* Company Information */}
        <Card>
          <CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="font-medium text-sm text-muted-foreground">Company Name (Insured)</p>
              ...
              <div>
                <p className="font-medium text-sm text-muted-foreground">State of Incorporation</p>
              ...
              <div>
                <p className="font-medium text-sm text-muted-foreground">Company Contact Number</p>
                <p className="font-medium">{formatValue(data.contactPersonNo)}</p>
              </div>
              <div>
                <p className="font-medium text-sm text-muted-foreground">Business Type/Occupation</p>
                <p className="font-medium">{formatValue(data.businessTypeOccupation)}</p>
              </div>
              <div>
              ...
              <div>
                <p className="font-medium text-sm text-muted-foreground">Email Address of the Company</p>
...
export default CorporateNFIUViewer;
