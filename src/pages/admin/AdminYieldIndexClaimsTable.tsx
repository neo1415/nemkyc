...
const AdminYieldIndexClaimsTable: React.FC = () => {
  ...
  const fetchForms = async () => {
    try {
      setLoading(true);
      const formsRef = collection(db, 'yield-index-claims');
  ...
  const handleView = (id: GridRowId) => {
    navigate(`/admin/form/yield-index-claims/${id}`);
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      await deleteDoc(doc(db, 'yield-index-claims', selectedFormId));
  ...
  const handleStatusUpdate = async (id: string, newStatus: string) => {
    try {
      await updateDoc(doc(db, 'yield-index-claims', id), {
        status: newStatus
      });
  ...
  const exportToCSV = () => {
    const headers = [
      ...
      'Loss Date From', 'Loss Date To', 'Cause of Loss', 'Pest/Disease Specification', 'Other Cause Explanation',
      'Crop Type', 'Crop Growth Stage', 'Cost of Land Preparation', 'Cost of Planting', 'Cost of Herbicides', 
      'Cost of Fertilizer', 'Quantity Salvaged', 'Proportion of Loss', 'Claim Estimate', 'Estimated Area of Damage',
      'Number of Farmers Affected', 'Previous Loss Particulars', 'Contact Details at Loss Premises', 'Additional Loss Details',
    ...
    const rows = filteredForms.map(form => [
      ...
      formatDate(form.lossDateFrom),
      formatDate(form.lossDateTo),
      getValue(form, 'causeOfLoss'),
      getValue(form, 'pestDiseaseSpecification'),
      getValue(form, 'otherCauseExplanation'),
      getValue(form, 'cropType'),
      getValue(form, 'cropGrowthStage'),
      getValue(form, 'costOfLandPreparation'),
      getValue(form, 'costOfPlanting'),
      getValue(form, 'costOfHerbicides'),
      getValue(form, 'costOfFertilizer'),
      getValue(form, 'quantitySalvaged'),
      getValue(form, 'proportionOfLoss'),
      getValue(form, 'claimEstimate'),
      getValue(form, 'estimatedAreaOfDamage'),
      getValue(form, 'numberOfFarmersAffected'),
      getValue(form, 'previousLossParticulars'),
      getValue(form, 'contactDetailsAtLossPremises'),
      getValue(form, 'additionalLossDetails'),
    ...
    link.download = `yield-index-claims-${new Date().toISOString().split('T')[0]}.csv`;
    link.click();
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      width: 130,
      renderCell: (params: any) => formatDate(params.row.lossDateFrom),
    },
    {
      field: 'lossDateTo',
      headerName: 'Loss Date To',
      width: 130,
      renderCell: (params: any) => formatDate(params.row.lossDateTo),
    },
    {
      field: 'causeOfLoss',
      headerName: 'Cause of Loss',
      width: 180,
      renderCell: (params: any) => getValue(params.row, 'causeOfLoss'),
    },
    {
      field: 'pestDiseaseSpecification',
      headerName: 'Pest/Disease Specification',
      width: 200,
      renderCell: (params: any) => getValue(params.row, 'pestDiseaseSpecification'),
    },
    {
    ...
    },
    {
      ...
      width: 150,
      renderCell: (params: any) => getValue(params.row, 'cropType'),
    },
    {
      field: 'cropGrowthStage',
      headerName: 'Crop Growth Stage',
      width: 180,
      renderCell: (params: any) => getValue(params.row, 'cropGrowthStage'),
    },
    {
      field: 'costOfLandPreparation',
      headerName: 'Cost of Land Preparation',
      width: 200,
      renderCell: (params: any) => getValue(params.row, 'costOfLandPreparation'),
    },
    {
      field: 'costOfPlanting',
      headerName: 'Cost of Planting',
      width: 150,
      renderCell: (params: any) => getValue(params.row, 'costOfPlanting'),
    },
    {
      field: 'costOfHerbicides',
      headerName: 'Cost of Herbicides',
      width: 150,
      renderCell: (params: any) => getValue(params.row, 'costOfHerbicides'),
    },
    {
      field: 'costOfFertilizer',
      headerName: 'Cost of Fertilizer',
      width: 150,
      renderCell: (params: any) => getValue(params.row, 'costOfFertilizer'),
    },
    {
      field: 'quantitySalvaged',
      headerName: 'Quantity Salvaged',
      width: 150,
      renderCell: (params: any) => getValue(params.row, 'quantitySalvaged'),
    },
    {
      field: 'proportionOfLoss',
      headerName: 'Proportion of Loss',
      width: 180,
      renderCell: (params: any) => getValue(params.row, 'proportionOfLoss'),
    },
    {
      field: 'claimEstimate',
    ...
    {
      field: 'estimatedAreaOfDamage',
      headerName: 'Estimated Area of Damage',
      width: 200,
      renderCell: (params: any) => getValue(params.row, 'estimatedAreaOfDamage'),
    },
    {
      field: 'numberOfFarmersAffected',
      headerName: 'Number of Farmers Affected',
      width: 200,
      renderCell: (params: any) => getValue(params.row, 'numberOfFarmersAffected'),
    },
    {
    ...
    },
    {
      ...
      headerName: 'Contact Details at Loss Premises',
      width: 250,
      renderCell: (params: any) => getValue(params.row, 'contactDetailsAtLossPremises'),
    },
    {
      field: 'additionalLossDetails',
      headerName: 'Additional Loss Details',
      width: 200,
      renderCell: (params: any) => getValue(params.row, 'additionalLossDetails'),
    },
    {
      field: 'status',
      headerName: 'Status',
        ...
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            <Typography variant="h4" component="h1" gutterBottom>
              Yield Index Insurance Claims Management
            </Typography>
            <Button
              variant="outlined"
              startIcon={<GetApp />}
...
export default AdminYieldIndexClaimsTable;
