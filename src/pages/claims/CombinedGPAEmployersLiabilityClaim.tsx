...
const CombinedGPAEmployersLiabilityClaim: React.FC = () => {
  ...
  const onFinalSubmit = (data: CombinedGPAEmployersLiabilityClaimData) => {
    if (user) {
      ...
      handleSubmitWithAuth(data, 'Combined GPA & Employers Liability Claim', handleSubmit);
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Dialog open={showSummary} onOpenChange={setShowSummary}>
          <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
            <DialogHeader>
              <DialogTitle>Review Your Combined GPA & Employers Liability Claim Submission</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
        ...
        <div className="relative">
          <SuccessModal
            ...
            title="Combined GPA & Employers Liability Claim Submitted Successfully!"
            message="Your combined GPA & employers liability claim has been submitted and you'll receive a confirmation email shortly."
            formType="combined-gpa-employers-liability-claim"
