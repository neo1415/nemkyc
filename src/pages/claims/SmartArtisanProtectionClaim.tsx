...
// Smart Artisan Protection Claim Schema
const smartArtisanProtectionSchema = yup.object().shape({
...
interface SmartArtisanProtectionData {
  // Section 1: Policy Information
  policyNumber: string;
...
const defaultValues: Partial<SmartArtisanProtectionData> = {
  witnesses: [],
...
const SmartArtisanProtectionClaim: React.FC = () => {
  ...
  const formMethods = useForm<any>({
    resolver: yupResolver(smartArtisanProtectionSchema),
    defaultValues,
    mode: 'onChange'
  });
  ...
  const { saveDraft, clearDraft } = useFormDraft('smartArtisanProtectionClaim', formMethods);
  ...
  const onFinalSubmit = async (data: SmartArtisanProtectionData) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            Smart Artisan Protection Claim Form
          </CardTitle>
      ...
      <SuccessModal
        ...
        message="Your Smart Artisan Protection claim has been submitted and is being processed. You will receive a confirmation email shortly."
      />
    </div>
  );
};

export default SmartArtisanProtectionClaim;