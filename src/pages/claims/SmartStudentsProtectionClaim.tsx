...
// Smart Students Protection Claim Schema
const smartStudentsProtectionSchema = yup.object().shape({
  ...
  nameOfInsured: yup.string().required("Student/Pupil's name is required"),
...
interface SmartStudentsProtectionData {
  // Section 1: Policy Information
  policyNumber: string;
...
const defaultValues: Partial<SmartStudentsProtectionData> = {
  witnesses: [],
...
const SmartStudentsProtectionClaim: React.FC = () => {
  ...
  const formMethods = useForm<any>({
    resolver: yupResolver(smartStudentsProtectionSchema),
    defaultValues,
    mode: 'onChange'
  });
  ...
  const { saveDraft, clearDraft } = useFormDraft('smartStudentsProtectionClaim', formMethods);
  ...
  const onFinalSubmit = async (data: SmartStudentsProtectionData) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      component: (
        <FormProvider {...formMethods}>
          <div className="space-y-4">
            <FormField name="nameOfInsured" label="Student/Pupil's Name" required />
            <FormTextarea name="address" label="Contact Address" required />
            <FormField 
              name="phone" 
              label="Phone" 
              required 
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            Smart Students Protection Claim Form
          </CardTitle>
          ...
          return (
            <div className="space-y-6">
              ...
              <div className="border rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="font-medium text-gray-600">Student/Pupil Name:</span>
      ...
      <SuccessModal
        ...
        message="Your Smart Students Protection claim has been submitted and is being processed. You will receive a confirmation email shortly."
      />
    </div>
  );
};

export default SmartStudentsProtectionClaim;