...
// Smart Traveller Protection Claim Schema
const smartTravellerProtectionSchema = yup.object().shape({
...
interface SmartTravellerProtectionData {
  // Section 1: Policy Information
  policyNumber: string;
...
const defaultValues: Partial<SmartTravellerProtectionData> = {
  witnesses: [],
...
const SmartTravellerProtectionClaim: React.FC = () => {
  ...
  const formMethods = useForm<any>({
    resolver: yupResolver(smartTravellerProtectionSchema),
    defaultValues,
    mode: 'onChange'
  });
  ...
  const { saveDraft, clearDraft } = useFormDraft('smartTravellerProtectionClaim', formMethods);
  ...
  const onFinalSubmit = async (data: SmartTravellerProtectionData) => {
  ...
  const stepFieldMappings = {
    ...
    1: ['companyName', 'address', 'phone', 'email'], // Section 2: Insured Details
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            Smart Traveller Protection Claim Form
          </CardTitle>
      ...
      <SuccessModal
        ...
        message="Your Smart Traveller Protection claim has been submitted and is being processed. You will receive a confirmation email shortly."
      />
    </div>
  );
};

export default SmartTravellerProtectionClaim;