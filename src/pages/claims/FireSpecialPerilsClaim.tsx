...
const fireSpecialPerilsSchema = yup.object().shape({
  ...
  fireServiceNotified: yup.string().oneOf(['yes', 'no']).required('Fire service notification status is required'),
  fireServiceStation: yup.string().when('fireServiceNotified', {
    is: 'yes',
    then: (schema) => schema.required('Fire service station is required when fire service is notified')
  }),
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {formMethods.formState.errors.causeOfLoss && (
                <p className="text-sm text-red-600 mt-1">
                  {formMethods.formState.errors.causeOfLoss.message}
                </p>
              )}
            </div>
            ...
            <div>
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="fire-service-yes">Yes</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="no" id="fire-service-no" />
                  <Label htmlFor="fire-service-no">No</Label>
                </div>
              </RadioGroup>
              {formMethods.formState.errors.fireServiceNotified && (
                <p className="text-sm text-red-600 mt-1">
                  {formMethods.formState.errors.fireServiceNotified.message}
                </p>
              )}
            </div>
            ...
            {watchedValues.fireServiceNotified === 'yes' && (
              <div>
                ...
                />
                {formMethods.formState.errors.fireServiceStation && (
                  <p className="text-sm text-red-600 mt-1">
                    {formMethods.formState.errors.fireServiceStation.message}
                  </p>
                )}
              </div>
            )}
            ...
            <div>
              ...
              {formMethods.formState.errors.damageDescription && (
                <p className="text-sm text-red-600 mt-1">
                  {formMethods.formState.errors.damageDescription.message}
                </p>
              )}
            </div>
