...
// Smart Generation Z Protection Claim Schema
const smartGenerationZProtectionSchema = yup.object().shape({
...
interface SmartGenerationZProtectionData {
  // Section 1: Policy Information
  policyNumber: string;
...
const defaultValues: Partial<SmartGenerationZProtectionData> = {
  witnesses: [],
...
const SmartGenerationZProtectionClaim: React.FC = () => {
  ...
  const formMethods = useForm<any>({
    resolver: yupResolver(smartGenerationZProtectionSchema),
    defaultValues,
    mode: 'onChange'
  });
  ...
  const { saveDraft, clearDraft } = useFormDraft('smartGenerationZProtectionClaim', formMethods);
  ...
  const onFinalSubmit = async (data: SmartGenerationZProtectionData) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold text-gray-900">
            Smart Generation Z Protection Claim Form
          </CardTitle>
      ...
      <SuccessModal
        ...
        message="Your Smart Generation Z Protection claim has been submitted and is being processed. You will receive a confirmation email shortly."
      />
    </div>
  );
};

export default SmartGenerationZProtectionClaim;