...
import { Plus, Trash2, Check, Info, Loader2, AlertCircle } from 'lucide-react';
        ...
        <div className="space-y-6">
          <div>
            ...
            <FileUpload
              ...
              maxSize={3 * 1024 * 1024}
            />
            {uploadedFiles.verificationDocUrl && (
              <div className="flex items-center gap-2 mt-2 text-sm text-green-600">
                <Check className="h-4 w-4" />
                {uploadedFiles.verificationDocUrl.name}
              </div>
            )}
              ...
              <div className="space-y-6">
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 gap-2 text-sm">
                    <div>
                      <span className="font-medium text-gray-600">CAC Verification Document:</span>
                      <p className="text-gray-900">{data.verificationDocUrl ? '✓ Uploaded' : 'Not uploaded'}</p>
                    </div>
                  </div>
                </div>
              </div>
