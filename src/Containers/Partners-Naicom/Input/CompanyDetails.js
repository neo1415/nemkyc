...
const CompanyDetails = ({register, errors}) => {
  ...
  <input type="number" {...register("telephoneNumber", { required: true, minLength: 5, maxLength: 11 })} placeholder='Contact Telephone Number' />
  ...
  {errors.BVNNo && <span className="error-message">{errors.BVNNo.message}</span>}
      ...
      <input  type="date" {...register("NAICOMLisenceExpiryDate",{ required: true, minLength: 10, maxLength: 15 })} placeholder='NAICOM Expiry Date' />
