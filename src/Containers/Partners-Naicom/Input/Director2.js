...
const Director2 = ({register, errors, formValues, control}) => {
  ...
  return (
    <div>   
      ...
      <input type="text" id="title2" placeholder='Title' {...register("title2", { required: false })} />
      {errors.title2 && <span className="error-message">{errors.title2.message}</span>}

      <label htmlFor="gender2">Gender </label>
      <select id="gender2" {...register("gender", { required: false })}>
      ...
      <input type='text' {...register("occupation2", { required: false, minLength: 3, maxLength: 30 })} placeholder='Occupation' />
      ...
      <input type='text' {...register("passIssuedCountry2", { required: false, minLength: 3, maxLength: 30 })} placeholder='Passport Issued Country' />
...
{errors.sourceOfIncome2 && <span className="error-message">This field is required</span>}
      ...
      <input type='text' {...register("nationality2", { required: false, minLength: 3, maxLength: 30 })} placeholder='Nationality' />
      ...
      <input type='email' {...register("email2", { required: false, pattern: /^\S+@\S+$/i , minLength: 6, maxLength: 30 })} placeholder='Email' />
