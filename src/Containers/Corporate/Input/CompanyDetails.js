...
const CompanyDetails = ({register, errors,control}) => {
  ...
  return (
    <div>    
      ...
      <input type='text' {...register("incorporationState", { required: true,  minLength: 3, maxLength: 50  })} placeholder='Registered Office' />
...
{errors.companyLegalForm && <span className="error-message">This field is required</span>}
      ...
      <input type="number" {...register("telephoneNumber", { required: true, minLength: 3, maxLength: 11 })} placeholder='telephone Number' />
