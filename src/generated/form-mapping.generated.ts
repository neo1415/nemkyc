...
export const FORM_MAPPINGS = {
  ...
  'naicom-corporate-c-d-d': {
    "title": "Naicom Corporate C D D",
    "sections": [
      {
      ...
      },
      {
        ...
        "fields": [
          ...
          { "key": "identification", "label": "Upload Means of Identification", "type": "file", "editable": true },
          { "key": "cacForm", "label": "NAICOM License Certificate", "type": "file", "editable": true }
        ]
      }
    ]
  },
  'naicom-partners-c-d-d': {
    "title": "Naicom Partners C D D", 
    "sections": [
      {
        "title": "General Information",
        "fields": [
          { "key": "partnershipName", "label": "Partnership Name", "type": "text", "editable": true },
          { "key": "registeredAddress", "label": "Registered Address", "type": "textarea", "editable": true },
          { "key": "city", "label": "City", "type": "text", "editable": true },
          { "key": "state", "label": "State", "type": "text", "editable": true },
          { "key": "country", "label": "Country", "type": "text", "editable": true },
          ...
          { "key": "registrationState", "label": "Registration State", "type": "text", "editable": true },
          { "key": "businessNature", "label": "Business Nature", "type": "textarea", "editable": true },
          { "key": "bvn", "label": "Bvn", "type": "text", "editable": true },
          { "key": "partners", "label": "Partners", "type": "array", "editable": true },
          { "key": "registrationCertificate", "label": "Registration Certificate", "type": "file", "editable": true },
          { "key": "businessLicense", "label": "Business License", "type": "file", "editable": true },
          { "key": "taxClearanceCertificate", "label": "Tax Clearance Certificate", "type": "file", "editable": true },
          { "key": "naicomLicense", "label": "Naicom License", "type": "file", "editable": true },
          { "key": "partnershipAgreement", "label": "Partnership Agreement", "type": "file", "editable": true },
          { "key": "memorandumOfUnderstanding", "label": "Memorandum Of Understanding", "type": "file", "editable": true },
          { "key": "certificateOfOccupancy", "label": "Certificate Of Occupancy", "type": "file", "editable": true }
        ]
      }
    ]
  },
  'partners-c-d-d': {
    "title": "Partners C D D",
    "sections": [
      {
        "title": "General Information",
        "fields": [
