...
import { Loader2, Shield, Phone, KeyRound } from 'lucide-react';
...
const MFAModal: React.FC<MFAModalProps> = ({ isOpen, onClose, type, onSuccess }) => {
  ...
  const { enrollMFA, verifyMFAEnrollment, verifyMFA, resendMFACode } = useAuth();
        ...
        <DialogContent className="sm:max-w-md" onPointerDownOutside={(e) => e.preventDefault()}>
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              {isEnrollmentFlow ? 'Set Up Two-Factor Authentication' : 'Two-Factor Authentication Required'}
            </DialogTitle>
          </DialogHeader>
