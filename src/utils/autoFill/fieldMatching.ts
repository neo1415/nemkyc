...
function getCommonAbbreviations(fieldName: string): string[] {
  const abbreviationMap: Record<string, string[]> = {
    ...
    registrationNumber: ['registration_number', 'Registration Number', 'rcNumber', 'rc_number', 'RC Number', 'cacNumber', 'cac_number', 'incorporationNumber', 'incorporation_number', 'Incorporation Number'],
    ...
    typeOfEntity: ['type_of_entity', 'Type Of Entity', 'entityType', 'entity_type', 'natureOfBusiness', 'nature_of_business', 'Nature of Business', 'businessTypeOccupation', 'business_type_occupation', 'Business Type/Occupation'],
    ...
    natureOfBusiness: ['typeOfEntity', 'type_of_entity', 'Type Of Entity', 'entityType', 'entity_type', 'businessTypeOccupation', 'business_type_occupation', 'Business Type/Occupation'],
    businessTypeOccupation: ['typeOfEntity', 'type_of_entity', 'Type Of Entity', 'entityType', 'entity_type', 'natureOfBusiness', 'nature_of_business', 'Nature of Business']
  };
