...
const IndividualKYCTable = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const response = await axios.get(endpoints.getIndividualKYCData);
            ...
            {userRole === 'admin' && (
              <>
                ...
                <div className="statusButton">
                  <StatusButton id={id} collection="Individual-kyc-form" setData={setData} />
                </div>
              </>
            )}
  ...
  return (
    <div className="list">
      ...
      <div className="datatable">
        <div className="datatableTitle">INDIVIDUAL KYC FORM
